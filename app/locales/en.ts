export default {
  ...
  userFallback: "user",
  totalGroves: "Total Groves",
  totalTrees: "Total Trees",
  totalArea: "Total Area",
  totalHarvestsCount: "Total Harvests",
  totalHarvestKg: "Total Harvest (kg)",
  totalOilYield: "Total Oil Yield (L)",
  avgOilYield: "Avg Oil Yield (%)",
  ...
  createdAt: "Created",
  editGrove: "Edit grove",
  editGroveDescription: "Edit olive grove details.",
  ...
  editHarvestDescription: "Edit harvest details.",
