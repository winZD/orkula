  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      ...
      <main className="flex flex-col md:flex-row flex-1 w-full">
        {/* Image Section */}
        <section className="w-full md:w-1/2 h-64 bg-cream">
          <div>
            {" "}
            <img
              src="/olives.png"
        ...
        {/* Description Section */}
        <section className="w-full md:w-1/2 flex flex-col items-start justify-center px-8 md:px-16 py-12 md:py-0 gap-6 bg-cream">
